...
#model select and perform V-fold cross-validation plus grid search for randomforest
model = RandomForestRegressor()
#param_grid = {"n_estimators":[5,10,50,100,200,500],"max_depth":[5,10,50,100,200,500],"n_jobs":[-1]}
param_grid = {"n_estimators":[500,800,1000],"max_depth":[200,150,250,300,350],"n_jobs":[-1]}
